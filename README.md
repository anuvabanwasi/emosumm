...
2. The main code for loading the data, tokenizing the data, and training BART on this data is in emotion_summarization.py. This includes training/testing on both baseline dataset (just COVIDET) and BART/T5 trained on COVIDET+GPT-generated data.
